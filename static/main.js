...
const translations = {
  ar: {
    ...
    aboutImageCaption: "مشهد هادئ يعكس أجواء التأمل والقراءة",
    bookEyebrow: "بين السطور",
    aboutBookTitle: "عن الكتاب",
    bookParagraphOne:
      "كتاب «أثر إلى السماء» هو إحدى إبداعات محمد حسن الموسى، وهو رحلة قصيرة بين النفس والحياة والإيمان، تدعوك إلى التأمل في علاقتك بالله، وفي أثر أعمالك وكلماتك وقراراتك.",
    bookParagraphTwo:
...
function storedLanguage() {
  try {
    const value = window.localStorage.getItem("preferred-language");
...
if (menuToggle && headerPanel) {
  ...
  const desktopQuery = window.matchMedia("(min-width: 48.01rem)");
